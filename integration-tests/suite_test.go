...
var _ = BeforeSuite(func() {
	...
	testEnv = &envtest.Environment{
		CRDDirectoryPaths: []string{filepath.Join("..", "charts", "monitoring-operator", "crds"),
			filepath.Join("..", "charts", "monitoring-operator", "charts", "grafana-operator", "crds"),
			filepath.Join("..", "charts", "monitoring-operator", "charts", "prometheus-adapter-operator", "crds"),
			filepath.Join("..", "charts", "monitoring-operator", "charts", "prometheus-operator", "crds"),
			filepath.Join("..", "charts", "monitoring-operator", "charts", "victoriametrics-operator", "crds")},
	}
